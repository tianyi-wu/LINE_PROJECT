...
# [PKs, Links, Titles, Descriptions] = get_data()
# NewsEntry = News(PKs,Links, Titles ,Descriptions, filters = True,show=False)
...
class Entry(models.Model):
    ...
    FisrtRevelant = models.ForeignKey('self', null=True, related_name='RevelantOne')
    SecondRevelant = models.ForeignKey('self', null=True, related_name='SecondRevelantTwo')
    ThirdRevelant = models.ForeignKey('self', null=True, related_name='RevelantThree')
